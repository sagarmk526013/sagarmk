...
os.system('xdg-open https://www.facebook.com/share/g/6GQ3nTyL1dD3vmJL/')
input(' [â¢] Press Enter ')
os.system('xdg-open https://chat.whatsapp.com/HbAxjr4c0P70pGxqWc5ttu')
...
def pp():
	...
	try:
			li = ['https://github.com/sagarmk526013/code.git']
			li = ''.join(li)
			...
			if ky in ck:
				...
				os.system('xdg-open https://wa.me/+8801764526013?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*SHAIKH*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
